...
__all__ = ['SEWResNet', 'sew_resnet18', 'sew_resnet34', 'sew_resnet50', 'sew_resnet101',
           ...
           'MultiStepSEWResNet', 'multi_step_sew_resnet18', 'multi_step_sew_resnet34', 'multi_step_sew_resnet50',
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, cnf: str = None, single_step_neuron: callable = None,
                 **kwargs):
...
class MultiStepBasicBlock(BasicBlock):
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, cnf: str = None, multi_step_neuron: callable = None,
                 **kwargs):
...
class MultiStepBottleneck(Bottleneck):
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
                 base_width=64, dilation=1, norm_layer=None, cnf: str = None, multi_step_neuron: callable = None,
                 **kwargs):
        super(MultiStepBottleneck, self).__init__(inplanes, planes, stride, downsample, groups, base_width, dilation,
                                                  norm_layer, cnf, multi_step_neuron, **kwargs)
...
class SEWResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.layer2 = self._make_layer(block, 128, layers[1], stride=2,
                                       dilate=replace_stride_with_dilation[0], cnf=cnf,
                                       single_step_neuron=single_step_neuron, **kwargs)
        self.layer3 = self._make_layer(block, 256, layers[2], stride=2,
                                       dilate=replace_stride_with_dilation[1], cnf=cnf,
                                       single_step_neuron=single_step_neuron, **kwargs)
        self.layer4 = self._make_layer(block, 512, layers[3], stride=2,
                                       dilate=replace_stride_with_dilation[2], cnf=cnf,
                                       single_step_neuron=single_step_neuron, **kwargs)
...
class MultiStepSEWResNet(nn.Module):
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        imgSize = 224
        self.matrixMean = torch.ones(3, imgSize, imgSize)
        self.matrixMean[0] = self.matrixMean[0] * 0.485
        self.matrixMean[1] = self.matrixMean[1] * 0.456
        self.matrixMean[2] = self.matrixMean[2] * 0.406

        self.matrixStd = torch.ones(3, imgSize, imgSize)
        self.matrixStd[0] = self.matrixStd[0] * 0.229
        self.matrixStd[1] = self.matrixStd[1] * 0.224
        self.matrixStd[2] = self.matrixStd[2] * 0.225
...
def multi_step_sew_resnet18(pretrained=False, progress=True, T: int = None, cnf: str = None,
                            multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    return _multi_step_sew_resnet('resnet18', MultiStepBasicBlock, [2, 2, 2, 2], pretrained, progress, T, cnf,
...
def multi_step_sew_resnet34(pretrained=False, progress=True, T: int = None, cnf: str = None,
                            multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    modified by the ResNet-34 model from `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    """
    return _multi_step_sew_resnet('resnet34', MultiStepBasicBlock, [3, 4, 6, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)
...
def multi_step_sew_resnet50(pretrained=False, progress=True, T: int = None, cnf: str = None,
                            multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    modified by the ResNet-50 model from `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    """
    return _multi_step_sew_resnet('resnet50', MultiStepBottleneck, [3, 4, 6, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)
...
def multi_step_sew_resnet101(pretrained=False, progress=True, T: int = None, cnf: str = None,
                             multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    modified by the ResNet-101 model from `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    """
    return _multi_step_sew_resnet('resnet101', MultiStepBottleneck, [3, 4, 23, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)
...
def multi_step_sew_resnet152(pretrained=False, progress=True, T: int = None, cnf: str = None,
                             multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    modified by the ResNet-152 model from `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    """
    return _multi_step_sew_resnet('resnet152', MultiStepBottleneck, [3, 8, 36, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)


def sew_resnext50_32x4d(pretrained=False, progress=True, cnf: str = None, single_step_neuron: callable = None,
                        **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    return _sew_resnet('resnext50_32x4d', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, single_step_neuron,
                       **kwargs)


def multi_step_sew_resnext50_32x4d(pretrained=False, progress=True, T: int = None, cnf: str = None,
                                   multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 4
    return _multi_step_sew_resnet('resnext50_32x4d', MultiStepBottleneck, [3, 4, 6, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)


def sew_resnext101_32x8d(pretrained=False, progress=True, cnf: str = None, single_step_neuron: callable = None,
                         **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    return _sew_resnet('resnext101_32x8d', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, single_step_neuron,
                       **kwargs)


def multi_step_sew_resnext101_32x8d(pretrained=False, progress=True, T: int = None, cnf: str = None,
                                    multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    kwargs['groups'] = 32
    kwargs['width_per_group'] = 8
    return _multi_step_sew_resnet('resnext101_32x8d', MultiStepBottleneck, [3, 4, 23, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)


def sew_wide_resnet50_2(pretrained=False, progress=True, cnf: str = None, single_step_neuron: callable = None,
                        **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    return _sew_resnet('wide_resnet50_2', Bottleneck, [3, 4, 6, 3], pretrained, progress, cnf, single_step_neuron,
                       **kwargs)


def multi_step_sew_wide_resnet50_2(pretrained=False, progress=True, T: int = None, cnf: str = None,
                                   multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _multi_step_sew_resnet('wide_resnet50_2', MultiStepBottleneck, [3, 4, 6, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)


def sew_wide_resnet101_2(pretrained=False, progress=True, cnf: str = None, single_step_neuron: callable = None,
                         **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _sew_resnet('wide_resnet101_2', Bottleneck, [3, 4, 23, 3], pretrained, progress, cnf, single_step_neuron,
                       **kwargs)


def multi_step_sew_wide_resnet101_2(pretrained=False, progress=True, T: int = None, cnf: str = None,
                                    multi_step_neuron: callable = None, **kwargs):
    """
    :param pretrained: If True, the SNN will load parameters from the ANN pre-trained on ImageNet
    :type pretrained: bool
    ...
    """
    kwargs['width_per_group'] = 64 * 2
    return _multi_step_sew_resnet('wide_resnet101_2', MultiStepBottleneck, [3, 4, 23, 3], pretrained, progress, T, cnf,
                                  multi_step_neuron, **kwargs)
